...
[![Version](https://img.shields.io/badge/version-1.8.13-blue)](CHANGELOG.md)
...
| [docs/fr/SYNCHRONISATION.md](docs/fr/SYNCHRONISATION.md) *(FR)* | LAN synchronization with morfSync (offline-first) |
